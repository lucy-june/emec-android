...
import com.adc.huijin.adapter.IndexGalleryAdapter;
import com.adc.huijin.entity.IndexGalleryItemData;
import com.adc.huijin.ui.base.BaseActivity;
import com.adc.huijin.utils.CommonTools;
import com.adc.huijin.widgets.HomeSearchBarPopupWindow;
import com.adc.huijin.widgets.HomeSearchBarPopupWindow.onSearchBarItemClickListener;
import com.adc.huijin.widgets.jazzviewpager.JazzyViewPager;
import com.adc.huijin.widgets.jazzviewpager.JazzyViewPager.TransitionEffect;
import com.adc.huijin.widgets.jazzviewpager.OutlineContainer;
import com.adc.huijin.zxing.CaptureActivity;
...
public class IndexActivity extends BaseActivity implements OnClickListener,
	...
	public class MyAdapter extends PagerAdapter {
		...
		MyAdapter(){
			mImageViews[0].setImageResource(R.drawable.image01);
			mImageViews[1].setImageResource(R.drawable.image02);
			mImageViews[2].setImageResource(R.drawable.image03);
			mImageViews[3].setImageResource(R.drawable.image04);
			mImageViews[4].setImageResource(R.drawable.image05);
			mImageViews[5].setImageResource(R.drawable.image06);
			mImageViews[6].setImageResource(R.drawable.image07);
			mImageViews[7].setImageResource(R.drawable.image08);
		}
		...
		public Object instantiateItem(View container, int position) {
			//System.out.println("GGGGGGGGGGGGGGGG\t"+mImageUrls.get(position));
